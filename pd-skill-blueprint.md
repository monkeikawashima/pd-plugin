...
├── skills/ux-*/ ほか15種            UI/UX スキル。**5層すべてに担当がある**（v1.2.0）
│                                  戦略 strategy-insight-writer / user-persona-builder
│                                  要件 user-story-writer / ux-journey-mapper
│                                  構造 object-model-reviewer
│                                  骨格 ux-screen-spec-writer（作る前）/ ux-design-review（作った後）
│                                  表層 design-token-keeper / a11y-contrast-guard
│                                  横断 ux-layer-triage / user-voice-ledger / ux-decision-record /
│                                       ux-validation-planner / ux-measurement / ux-update-cascade
